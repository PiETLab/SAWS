 ...
 * @modified by Fatima
 */
public class Venkatagiri99Set extends SourceSymbolSet {

	public Venkatagiri99Set() {
		super();
		// For ease-of-use, compose the probability distribution in a
		// spreadsheet and then cut and paste the lines below
		this.addToSymbolSet(JIndirectSelectionButton.VK_SPACE_SYMBOL, 0.165092782143565);
		...
		this.addToSymbolSet(JIndirectSelectionButton.VK_Q, 0.000990556692861388);
		this.addToSymbolSet(JIndirectSelectionButton.VK_Z, 0.000660371128574259);
		this.addToSymbolSet(JIndirectSelectionButton.VK_COMMA, 0.00065211648946708);
		this.addToSymbolSet(JIndirectSelectionButton.VK_PERIOD, 0.000643861850359902);
		this.addToSymbolSet(JIndirectSelectionButton.VK_QUESTIONMARK, 0.000635607211252724);
		this.addToSymbolSet(JIndirectSelectionButton.VK_APOSTROPHE, 0.000627352572145546);
		this.addToSymbolSet(JIndirectSelectionButton.VK_PILCROW, 0.000619097933038368);
		this.addToSymbolSet(JIndirectSelectionButton.VK_DEL, 0.000610843293931189);
		this.addToSymbolSet(JIndirectSelectionButton.VK_1, 0.000602588654824011);
		this.addToSymbolSet(JIndirectSelectionButton.VK_2, 0.000594334015716833);
		this.addToSymbolSet(JIndirectSelectionButton.VK_3, 0.000586079376609655);
		this.addToSymbolSet(JIndirectSelectionButton.VK_4, 0.000577824737502476);
		this.addToSymbolSet(JIndirectSelectionButton.VK_5, 0.000569570098395298);
		this.addToSymbolSet(JIndirectSelectionButton.VK_6, 0.00056131545928812);
		this.addToSymbolSet(JIndirectSelectionButton.VK_7, 0.000553060820180942);
		this.addToSymbolSet(JIndirectSelectionButton.VK_8, 0.000544806181073763);
		this.addToSymbolSet(JIndirectSelectionButton.VK_9, 0.000536551541966585);
		this.addToSymbolSet(JIndirectSelectionButton.VK_0, 0.000528296902859407);
		// */
		if (!this.isSumsTo1()) {
