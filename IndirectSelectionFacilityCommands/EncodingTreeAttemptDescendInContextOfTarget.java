...
public class EncodingTreeAttemptDescendInContextOfTarget extends IndirectSelectionFaciltyCommand {
	 ...
	 * 
	 */
	public EncodingTreeAttemptDescendInContextOfTarget(String target) {
		super();
