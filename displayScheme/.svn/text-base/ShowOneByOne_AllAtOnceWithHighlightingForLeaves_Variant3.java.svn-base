 ...
 * highlighting: shown highlighting with yellow
 * 
 ...
 * 
 */
public class ShowOneByOne_AllAtOnceWithHighlightingForLeaves_Variant3 extends
	...
	public ShowOneByOne_AllAtOnceWithHighlightingForLeaves_Variant3(
	...
	// /**
	// * Derive the optimal font for this view, which is the largest possible
	// font
	...
	// * @return
	// */
	// private Font getOptimalFont() {
	// int maxPointSizeWidthwise = getMaxPointSizeWidthwise(getButtonWidth());//
	// -
	// // 2
	// // *
	// int maxPointSizeHeightwise =
	// getMaxPointSizeHeightwise(getButtonHeight());// -
	// // 2
	// // *
	...
	// // System.out.println("Width available per each of the "
	// // + maxNumberHorizontalElements + " elements: " + widthPerElement
	// // + "\t max font size: " + maxPointSize);
	// return super.getFont().deriveFont((float) (max) - 0f);
	// }
