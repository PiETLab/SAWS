...
public class Model implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4102672312943249501L;
	...
	public boolean init() {
		...
		String modelFile = taggerOpt.modelDir + File.separator
				+ taggerOpt.modelFile;
	...
	public void inferenceAll(List data) {
		...
		System.out.println("Inference " + Integer.toString(data.size())
				+ " sequences completed!");
		System.out.println("Inference time: "
				+ Double.toString((double) elapsed / 1000) + " seconds");
	}
