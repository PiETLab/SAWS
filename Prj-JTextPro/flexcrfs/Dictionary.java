...
public class Dictionary implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2873942639779258317L;

	public Map<Integer, Element> dict = null; // map between context predicate

	// and element

	Dictionary() {
		dict = new HashMap<Integer, Element>();
	}
