...
\begin{small}
\begin{bundle}{}
\chunk[]{\begin{bundle}{1234567890JQZ,.?'$\P$?`XVKBFMGWYPLDUCTAOINSRH$\sqcup$E}
 \chunk[]{\begin{bundle}{1234567890JQZ,.?'$\P$?`XVKBFMGWYPLDUCTAOI}
 \chunk[]{\begin{bundle}{1234567890JQZ,.?'$\P$?`XVKBFMGWYPLDUC}
 \chunk[]{\begin{bundle}{1234567890JQZ,.?'$\P$?`XVKBFMGWYP}
 \chunk[]{\begin{bundle}{1234567890JQZ,.?'$\P$?`XVKBFM}
 \chunk[]{\begin{bundle}{1234567890JQZ,.?'$\P$?`XVKB}
 \chunk[]{\begin{bundle}{1234567890JQZ,.?'$\P$?`X}
 \chunk[]{\begin{bundle}{1234567890JQZ}
 \chunk[]{\begin{bundle}{12345678}
 \chunk[]{\begin{bundle}{1234}
 \chunk[]{\begin{bundle}{12}
 \chunk[]{1}
 \chunk[]{2}
\end{bundle}}
 \chunk[]{\begin{bundle}{34}
 \chunk[]{3}
 \chunk[]{4}
\end{bundle}}
\end{bundle}}
 \chunk[]{\begin{bundle}{5678}
 \chunk[]{\begin{bundle}{56}
 \chunk[]{5}
 \chunk[]{6}
\end{bundle}}
 \chunk[]{\begin{bundle}{78}
 \chunk[]{7}
 \chunk[]{8}
\end{bundle}}
\end{bundle}}
\end{bundle}}
 \chunk[]{\begin{bundle}{90JQZ}
 \chunk[]{\begin{bundle}{90J}
 \chunk[]{\begin{bundle}{90}
 \chunk[]{9}
 \chunk[]{0}
\end{bundle}}
 \chunk[]{J}
\end{bundle}}
 \chunk[]{\begin{bundle}{QZ}
 \chunk[]{Q}
 \chunk[]{Z}
\end{bundle}}
\end{bundle}}
\end{bundle}}
 \chunk[]{\begin{bundle}{,.?'$\P$?`X}
 \chunk[]{\begin{bundle}{,.?'}
 \chunk[]{\begin{bundle}{,.}
 \chunk[]{,}
 \chunk[]{.}
...
\end{bundle}}
\end{bundle}}
 \chunk[]{\begin{bundle}{VKB}
 \chunk[]{\begin{bundle}{VK}
 \chunk[]{V}
 \chunk[]{K}
\end{bundle}}
 \chunk[]{B}
\end{bundle}}
\end{bundle}}
 \chunk[]{\begin{bundle}{FM}
 \chunk[]{F}
 \chunk[]{M}
\end{bundle}}
\end{bundle}}
 \chunk[]{\begin{bundle}{GWYP}
 \chunk[]{\begin{bundle}{GW}
 \chunk[]{G}
 \chunk[]{W}
\end{bundle}}
 \chunk[]{\begin{bundle}{YP}
 \chunk[]{Y}
 \chunk[]{P}
\end{bundle}}
\end{bundle}}
\end{bundle}}
 \chunk[]{\begin{bundle}{LDUC}
 \chunk[]{\begin{bundle}{LD}
 \chunk[]{L}
 \chunk[]{D}
\end{bundle}}
 \chunk[]{\begin{bundle}{UC}
 \chunk[]{U}
 \chunk[]{C}
\end{bundle}}
\end{bundle}}
...
\end{bundle}}
\end{bundle}}
 \chunk[]{\begin{bundle}{NSRH$\sqcup$E}
 \chunk[]{\begin{bundle}{NSRH}
 \chunk[]{\begin{bundle}{NS}
 \chunk[]{N}
 \chunk[]{S}
\end{bundle}}
 \chunk[]{\begin{bundle}{RH}
 \chunk[]{R}
 \chunk[]{H}
\end{bundle}}
\end{bundle}}
