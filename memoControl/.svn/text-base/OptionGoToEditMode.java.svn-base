...
public class OptionGoToEditMode extends EditMenuOption {

	private String fullName = "Edit Memo Body";
	private double probability;
	private IndirectSelectionFaciltyCommand associatedCommand;

	public OptionGoToEditMode() {
		probability = 0;
	...
	public int compareTo(SourceSymbol sgm) {
		...
		return this.fullName
				.compareTo(((OptionGoToEditMode) sgm).getFullName());
	}

	public int compareTo(OptionGoToEditMode sgm) {
	...
	public boolean equals(OptionGoToEditMode sgm) {
	...
	public OptionGoToEditMode clone() {
