...
public class VerticalAlignmentParameter extends InvocationParameter {

	private String PARAMETER_PREFIX = InvocationParameterPrefixes.VerticalAlignmentParameter;//"ha";
	...
	public String getVerboseExplaination() {
		...
		return super.getArgumentPrefix()
				+ getParameterPrefix()
				+ " X, where X is int representing horiz alignment (TOP, CENTER, BOTTOM = 1, 0, 3 resp'y).  Default is "
				+ DEFAULT + "";
