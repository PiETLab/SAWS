 ...
 * 
 */
public class KonheimSetCharactersAndSpaceOnly extends SourceSymbolSet {

	public KonheimSetCharactersAndSpaceOnly() {
		...
		this.addToSymbolSet(JIndirectSelectionButton.VK_SPACE_TEXT, 0.166777851901267);
		...
		this.addToSymbolSet(JIndirectSelectionButton.VK_O, 0.0664609739826551);
		...
		this.addToSymbolSet(JIndirectSelectionButton.VK_S, 0.0506170780520347);
		this.addToSymbolSet(JIndirectSelectionButton.VK_H, 0.0440293529019346);
		this.addToSymbolSet(JIndirectSelectionButton.VK_D, 0.0315210140093396);
		this.addToSymbolSet(JIndirectSelectionButton.VK_L, 0.0282688458972648);
		...
		this.addToSymbolSet(JIndirectSelectionButton.VK_G, 0.0165943962641761);
		this.addToSymbolSet(JIndirectSelectionButton.VK_P, 0.0165943962641761);
		this.addToSymbolSet(JIndirectSelectionButton.VK_Y, 0.0165943962641761);
		...
		this.addToSymbolSet(JIndirectSelectionButton.VK_V, 0.0076717811874583);
		...
		this.addToSymbolSet(JIndirectSelectionButton.VK_Q, 0.0010006671114076);
