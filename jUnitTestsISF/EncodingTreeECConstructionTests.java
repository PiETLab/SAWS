 ...
 * 
 */
public class EncodingTreeECConstructionTests extends TestCase {

	public EncodingTreeECConstructionTests(String name) {
		super(name);
	}
	...
	private void assertBounds(Double val, Double lowerBound, Double upperBound) {
