...
set xlabel "Mean Number of Select Actions"  font "Times-Roman,18"
...
set view 0, 0, 1, 1
load	'labels.plt'
plot	'keyboardVariants.Huffman_k2.dat' using 3:6 title "k2,U1" with points ls 1, \
	'keyboardVariants.Huffman_k7.dat' using 3:6 title  "k7,U1" with points ls 2, \
	'keyboardVariants.Huffman_k8.dat' using 3:6 title  "k8,U1" with points ls 3, \
	'keyboardVariants.Huffman_k10.dat' using 3:6 title  "k10,U1" with points ls 4, \
	'keyboardVariants.RowColModLexicographic.dat' using 3:6 title  "RCL,U1" with points ls 7, \
	'keyboardVariants.RowColModQWERTY.dat' using 3:6 title  "RCQ,U1" with points ls 6, \
	'keyboardVariants.RowColUnigram.dat' using 3:6 title  "RCU,U1" with points ls 5,\
	'keyboardVariants.LinearUnigram.dat' using 3:6 title  "LU,U1" with points ls 10

#	'keyboardVariants.LinearModLexicographic.dat' using 3:6 title  "LL,U1" with points ls 8,\
#	'keyboardVariants.LinearModQWERTY.dat' using 3:6 title  "LQ,U1" with points ls 9,\
