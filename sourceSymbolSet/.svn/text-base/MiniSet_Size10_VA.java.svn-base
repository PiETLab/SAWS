 ...
 * 
 */
public class MiniSet_Size10_VA extends SourceSymbolSet {

	public MiniSet_Size10_VA() {
		...
		this.addToSymbolSet(JIndirectSelectionButton.VK_Q, 0.166777851901267);
		this.addToSymbolSet(JIndirectSelectionButton.VK_O, 0.108739159439626);
		// // this.addToSymbolSet(JIndirectSelectionButton.VK_T,
		// 0.0871414276184123);
		...
		// // this.addToSymbolSet(JIndirectSelectionButton.VK_R,
		// 0.056454302868579);
		...
		// 0.0282688458972648);
		// this.addToSymbolSet(JIndirectSelectionButton.VK_F,
		// 0.0240993995997331);
		this.addToSymbolSet(JIndirectSelectionButton.VK_C, 0.0232655103402268);
		//
		// this.addToSymbolSet(JIndirectSelectionButton.VK_M,
		// 0.0207638425617078);
