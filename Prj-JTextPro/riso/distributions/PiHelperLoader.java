...
long tt0 = System.currentTimeMillis();
	...
	public static Object invoke_description( Class c )
	{
		try
		{
System.err.println ("invoke_description: Class c: "+c);
			Field f = c.getField ("description_array");
System.err.println ("invoke_description: Field f: "+f);
System.err.println ("invoke_description: f.get (null): "+f.get (null));
			return f.get (null);
		}
		//catch (NoSuchFieldException e) {} // eat the exception; apparently c is not a helper
catch (NoSuchFieldException e) { System.err.println ("invoke_description: getField fails on "+c+": "+e); }
 
        //catch (Exception e) {} // HMM, SHOULD WE TRY HARDER TO FIGURE OUT WHAT'S GOING ON HERE ???
catch (Exception e) { System.err.println ("invoke_description: exception: "+e); }
