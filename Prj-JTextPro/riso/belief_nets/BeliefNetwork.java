...
public class BeliefNetwork extends RemoteObservableImpl implements AbstractBeliefNetwork, Serializable, Perishable
{
	...
	public void set_stale()
	{
		for ( Enumeration enum1 = variables.elements(); enum1.hasMoreElements(); )
			((Variable)enum1.nextElement()).set_stale();
...
System.err.println ("joint_posterior_calculation: "+x[depth].get_name()+" set to "+i);
	...
	public String format_string (String leading_ws) throws RemoteException
	{
		...
		for ( Enumeration enum1 = variables.elements(); enum1.hasMoreElements(); )
		{
			AbstractVariable x = (AbstractVariable) enum1.nextElement();
	...
	public String dot_format() throws RemoteException
	{
		...
		for ( Enumeration enum1 = lost_parents.elements(); enum1.hasMoreElements(); )
		{
		...
		for ( Enumeration enum1 = bn_list.elements(); enum1.hasMoreElements(); )
			result += one_dot_format( (AbstractBeliefNetwork)enum1.nextElement() );
