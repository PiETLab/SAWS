 ...
 * 
 */
public class ProbDist_IdealDomainSizeFive extends
	 ...
	 * n 1/8
	 */
	public ProbDist_IdealDomainSizeFive() {
		this.put(SourceSymbol.VK_E, Math.pow(2,-2));
		this.put(SourceSymbol.VK_T, Math.pow(2,-2));
